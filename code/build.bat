...
set linker_flags=
set include_paths=-I../code/ -I../run_tree/deps/ -I../run_tree/deps/stb/ -I../run_tree/deps/sokol/ -I../run_tree/deps/glad/include/ -I../run_tree/deps/SDL3/include/
set libs=-L../run_tree/deps/glad/src/ -L../run_tree/deps/SDL3/lib/ -lopengl32 -lSDL3-Static -luser32 -lgdi32 -lwinmm -lshell32 -lole32 -luuid -lversion -lglad -ladvapi32 -lsetupapi -lcfgmgr32 -loleaut32 -limm32 
