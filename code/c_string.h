...
internal        string_t    c_string_make_copy(memory_arena_t *arena, string_t string);
...
internal inline void        c_string_advance_by(string_t *string, u32 advance);

internal inline u32         c_string_find_first_char_from_left(string_t string,  char character);
...
internal        string_t    c_string_override_file_separators(string_t string);
